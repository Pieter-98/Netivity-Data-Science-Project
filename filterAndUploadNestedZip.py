...
def main():
    ...
    with zipfile.ZipFile(filename, "r") as file:
        ...
        for zipfilepath in file.namelist():
            extracted = file.extract(zipfilepath)
            with zipfile.ZipFile(extracted, "r") as nestedzip:
                for blob in nestedzip.namelist():   
                    processRequests(nestedzip, blob)
